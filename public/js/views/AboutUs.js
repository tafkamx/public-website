            ...
            <div class="page__body">\
                <div class="page__intro-wrapper -color-bg-neutral-xx-light">\
                    <div class="page__intro -tac">\
                        ...
                        <p class="page__intro-text -font-light">This is a crowded industry with many companies competing in the digital environment, but very few of them providing value creation with the products and services they make. <span class="-color-purple">Our process is important and very good</span>, but what really places us in a tiny group of awesome firms is that we seek to ask the right questions before attempting to find an answer. We are a talented group of awesome people on a life mission to make people’s lives better through design and innovation. Fuel partners whom we believe in and that combine profit and purpose. Together we can make things that are beneficial and valuable to the world. <span class="-font-bold">We believe in a world where things work better.</span></p>\
                    </div>\
                </div>\
